...
const Checkout: FC<CheckoutProps> = () => {
  ...
  useEffect(() => {
    ...
    const runLocalData = async () => {
      let data: resquestResponse = await getDatas("carrier");
      if (data.isSuccess) {
  ...
  return (
    <div className="Checkout">
      ...
      {openPayNowModal ? (
        <PaimentModal close={() => setOpenPayNowModal(false)} />
      ) : null}
          ...
          <div className="container">
            <div className="row">
              <div className="col-md-6">
                {/* <div className="col-lg-6"> //par Goli*/}
                          ...
                          return (
                            <tr key={item.product._id}>
                              <td>
                                ...
                                >
                                  {formatPrice(item.product.solde_price)} x
                                  {item.quantity}
                                </span>
                              </td>
