...
const Banner: FC<BannerProps> = () => {
  ...
  useEffect(() => {
    ...
    const runLocalData = async () => {
      const data: resquestResponse = await getDatasByPage("slide", 1, 3);
      if (data.isSuccess) {
  ...
  return (
    <div className="banner_section slide_medium shop_banner_slider staggered-animation-wrap container-fuid px-5 ">
      <div
